...
public class Critical extends AppCompatActivity {
    ...
    public static final String mypreference = "myprefCritical";
    public static final String Critical = "criticalDescriptionKey";
    public static final String ImageCritical = "criticalImageKey";
    ...
    private void checkData() {
        ...
        if (sharedpreferences.contains(Critical)) {
            editText.setText(sharedpreferences.getString(Critical, ""));
        }
        if (sharedpreferences.contains(ImageCritical)) {
            textImage.setText(sharedpreferences.getString(ImageCritical, ""));
    ...
    public void saveData() {
        ...
        editor.putString(Critical, n);
        editor.putString(ImageCritical, m);
        editor.commit();
            ...
            case R.id.action_settings:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED){
                        ...
                        ActivityCompat.requestPermissions(Critical.this, new String[]{Manifest.permission.CAMERA}, REQUEST_PERMISSION_CAMERA);
                    }
                } else {
                    goToCamera();
                }
